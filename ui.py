...
import sys
from vars import WIDTH, HEIGHT, MEALS, BG_DIR, STARTER_DIR, MAIN_DIR, DESSERT_DIR, BTNS_DIR
from dishes import DO_DISH1, DO_DISH2, DO_DISH3, START_GAME
from font import get_font

SCREEN = pg.display.set_mode((WIDTH, HEIGHT))
BG = pg.image.load(os.path.join(BG_DIR, '2.jpg'))
...
def play():
    ...
    while True:
        ...
        back_img = pg.image.load(os.path.join(BTNS_DIR, 'right_btn.png')) 
        ...
        back_btn = Button(image=back_img, pos=(1155, 50),
...
def options():
    ...
    while True:
        ...
        OPTION_TEXT = get_font(45).render("This is a OPTIONS screen.",
                                          True, "white")
...
def main_menu():
    ...
    while True:
        ...
        CENTER_IMG = pg.image.load(os.path.join(BASE_DIR, 'icon 200x200.png')).convert_alpha()
        ...
        PLAY_BTN = Button(image=pg.image.load(os.path.join(BTNS_DIR, "play_btn.png"),
                          pos=(450, 515),
                          text_input="", font=get_font(35),
                          base_color="#d7fcd4", hovering_color="White")

        OPTION_BTN = Button(image=pg.image.load(path.join(BTNS_DIR, "settings.png"),
                            pos=(600, 515),
                            text_input="", font=get_font(35),
                            base_color="#d7fcd4", hovering_color="White")

        QUIT_BTN = Button(image=pg.image.load(os.path.join(BTNS_DIR, "exit.png"),
                          pos=(800, 515),
                          text_input="", font=get_font(35),
                          base_color="#d7fcd4", hovering_color="White")
        ...
        for event in pg.event.get():
            ...
            if event.type == pg.MOUSEBUTTONDOWN:
                if PLAY_BTN.checkForInput(MENU_MOUSE_POS):
                    play()
                    SCREEN.blit(pg.image.load(os.path.join(MAIN_DIR, '2.jpg'), (0, 0))
